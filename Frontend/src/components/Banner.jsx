            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-12'>
                <div className='order-2 md:order1 w-full md:w-1/2 mt-12 md:mt-32 '>
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt cumque id cupiditate sapiente mollitia repellendus asperiores? Ab officia architecto commodi ratione iste vitae earum cupiditate! Esse, mollitia itaque. Rerum, fugit.</p>
                        <label className="px-3 py-2 border-2 rounded-lg flex items-center gap-2">
                        <svg

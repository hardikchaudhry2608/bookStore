                ...
                <div className="navbar ">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow dark:bg-slate-900 dark:text-white">{navItems} </ul>
                        </div>
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className='hidden md:block'>
                            <label className=" px-3 py-2 border rounded-lg flex items-center gap-2">
                        ...
                        <div className="">
                            <a className="px-3 py-2 rounded-md cursor-pointer hover:bg-slate-600 bg-black text-white font-bold" onClick={()=> document.getElementById("my_modal_3").showModal()}
